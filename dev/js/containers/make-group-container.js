            ...
            return(
                <div id="makeGroupDialogue">
                    ...
                    <form onSubmit={this.makeNewGroup}>
                        ...
                        <h2 className="makeGroupDialogueTitle">Participants</h2>
                        <ul>
...
function mapStateToProps(state) {
    return {
        showMakeGroupDialogue: state.showMakeGroupDialogue,
